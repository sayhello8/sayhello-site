import{a8 as p,z as u,C as r,a9 as g,V as m,c as l,b as d,L as f,aa as y,A as v,h as _,i as x,G as b,R as h,l as w,M as C}from"./OrbitControls-9c9ee6bc.js";import{R as M,M as B}from"./index-1453e2ee.js";import{D as S}from"./index-4ec0cc76.js";import{S as z}from"./SkyBox-813c1e20.js";import{s as L}from"./stats.module-077ce25d.js";import{p as R,n as T,a as E,b as P,c as G,d as k}from"./negz-6d72d730.js";import{_ as A}from"./_plugin-vue_export-helper-c27b6911.js";import{g as F,h as N,o as O,c as I}from"./index-9ee60282.js";import"./lil-gui.module.min-f00c3c61.js";class D{constructor(e={}){const s={mesh:null,border:!0,borderColor:"#3D41AE",baseColor:"#08074B",headerColor:"#3D41AE"};if(this.options=Object.assign({},s,e),!this.options.mesh)throw new Error("GradientRiseLine 请传入mesh参数");this.instance=null,this.line=null,this.shader=null,this.render(),this.options.border&&this.renderBorder()}renderBorder(){const{mesh:e,borderColor:s}=this.options,o=new p(e.geometry),t=new u({uniforms:{u_border_color:{value:new r(s)}},vertexShader:`
        void main(){
